        ...
        <ul class="flex list-none m-0 p-0 gap-2 items-center">
            ...
            <li class="relative">
                <button v-styleclass="{
                    ...
                    enterActiveClass: 'scale-100 opacity-100',
                    leaveToClass: 'hidden',
                    leaveActiveClass: 'opacity-0',
                ...
                <div
                    class="absolute top-10 right-0 hidden w-64 p-3 bg-white dark:bg-surface-800 rounded-md shadow-md border border-surface-200 dark:border-surface-700 flex flex-col gap-4 origin-top z-10">
                    ...
                    <div class="flex flex-col gap-2 w-full">
                        ...
                        <div class="inline-flex p-1 items-start gap-1 rounded-lg border border-gray-100 w-full">
